...
final class BondExplainerService {
    ...
    enum ExplainState {
        ...
        case ready(String)       // generated by Apple Intelligence
        case fallback(String)    // template text, animated the same way
        case failed
    ...
    // MARK: Animated fallback (word by word — same UX as real streaming)
